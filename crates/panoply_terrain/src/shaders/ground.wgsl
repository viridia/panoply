...
@group(2) @binding(7)
var surface0: texture_2d<f32>;
@group(2) @binding(8)
var surface0_sampler: sampler;

@group(2) @binding(9)
var surface1: texture_2d<f32>;
@group(2) @binding(10)
...
@group(2) @binding(21)
var<uniform> biome_weight: mat4x4<f32>;

@group(2) @binding(22)
var<uniform> biome_surface: array<BiomeSurfaceAttrs, 4>;
...
struct VertexOutput {
    ...
    @location(3) biome_weight: vec4<f32>,
    @location(4) terrain_style: vec4<f32>,
};
...
fn vertex(vertex: Vertex, @builtin(instance_index) instance_index: u32) -> VertexOutput {
    ...
    out.biome_weight = vec4<f32>(
        dot(biome_weight[0], biome_interpolation),
        dot(biome_weight[1], biome_interpolation),
